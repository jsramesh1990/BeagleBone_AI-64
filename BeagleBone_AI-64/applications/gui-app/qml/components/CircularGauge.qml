...
Item {
    ...
    Shape {
        ...
        ShapePath {
            strokeWidth: root.lineWidth
            strokeColor: value > alertThreshold ? accentColor : root.color
            fillColor: "transparent"
            capStyle: ShapePath.RoundCap
        ...
        ShapePath {
            ...
            dashPattern: [4, 4]
            visible: alertThreshold > 0 && alertThreshold < 100
            ...
            PathAngleArc {
                ...
                startAngle: root.startAngle + (root.endAngle - root.startAngle) * 
                           ((alertThreshold - minValue) / (maxValue - minValue))
                sweepAngle: 2
            }
        }
    }
